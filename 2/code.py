...
def get_my_points_for_the_round(round: str):
    ...
    # my win conditions
    if (
        (my_choice == "X" and opponent_choice == "C")
        or (my_choice == "Y" and opponent_choice == "A")
        or (my_choice == "Z" and opponent_choice == "B")
    ):
        return WIN + POINTS_MAP.get(my_choice)
    # my loss condition
    elif (
        (my_choice == "X" and opponent_choice == "B")
        or (my_choice == "Y" and opponent_choice == "C")
        or (my_choice == "Z" and opponent_choice == "A")
    ):
