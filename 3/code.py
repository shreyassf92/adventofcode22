with open("./3/input.txt") as input:
    ...
    for rucksack in rucksacks:
        ...
        sum_priorities += (ord(common_item) - 96) if common_item.islower() else (ord(common_item) - 64 + 26)
    ...
    for i in range(0, len(rucksacks), 3):
        ...
        common_item = set.intersection(elf_one, set.intersection(elf_two, elf_three)).pop()

        sum_badge_priorities += (ord(common_item) - 96) if common_item.islower() else (ord(common_item) - 64 + 26)
